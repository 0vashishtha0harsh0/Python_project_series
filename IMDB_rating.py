...
for line in films:
    ...
    try:
        ...
        soup = BeautifulSoup(response.content, feature = "html.parser")
        ...
        for result in containers:
            ...
            if title in name:
                rating = result.find("div",class_="inline-block ratings-imdb-rating").get("data-value")
                genre = result.p.find("span", class_="genre").text.strip()
